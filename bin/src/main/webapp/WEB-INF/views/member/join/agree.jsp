...
<div id="content" class="cmem_ct_join">
    ...
    <div class="cmem_cont">
        ...
        <form id="agreeForm" method="POST" action="/regist/policies">
...
<script type="text/javascript" defer="defer">
    ...
    function viewPolicy(site) {
        popupWin("/regist/policies?site=" + site, "privacy_policy", 780, 600, "yes", "no");
    }

    function viewPolicyPopup(mbrOperScrnId) {
        popupWin("/regist/policies?mbrOperScrnId=" + mbrOperScrnId, "terms", 780, 600, "yes", "no");
    }
</script>
</div>
		<!-- footer -->
