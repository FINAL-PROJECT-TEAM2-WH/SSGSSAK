                                    ...
                                    <div class="exp_area notranslate">
                                       <div class="util_bx">
                                          ...
                                          <span style="display: none" class="disp_cart_data"
                                             ...
                                             type="hidden" name="attnTgtIdnfNo${list1[loop.index].id}" value="${list1[loop.index].id}">
                                    ...
                                    <div class="exp_area notranslate">
                                       <div class="util_bx">
                                          ...
                                          <span style="display: none" class="disp_cart_data"
                                             ...
                                             type="hidden" name="attnDivDtlCd" value="10"> <input
                                             type="hidden" name="siteNo" value="6004"> <input
                                             type="hidden" name="attnTgtIdnfNo${list2[loop.index].id}" value="${list2[loop.index].id}">
                                             <input type="hidden" name="attnTgtIdnfNo2" value="6005">
                                             <input type="hidden" name="uitemId" value="00000">
                                             <input type="hidden" name="notiTitle" value="상품이름">
                                             <input type="hidden" name="notiImgPath"
                                    ...
                                    <div class="exp_area notranslate">
                                       <div class="util_bx">
                                          ...
                                          <span style="display: none" class="disp_cart_data"
                                             ...
                                             type="hidden" name="attnDivDtlCd" value="10"> <input
                                             type="hidden" name="siteNo" value="6004"> <input
                                             type="hidden" name="attnTgtIdnfNo${list3[loop.index].id}" value="${list3[loop.index].id}">
                                             <input type="hidden" name="attnTgtIdnfNo2" value="6005">
                                             <input type="hidden" name="uitemId" value="00000">
                                             <input type="hidden" name="notiTitle" value="상품이름">
                                             <input type="hidden" name="notiImgPath"
                                    ...
                                    <div class="exp_area notranslate">
                                       <div class="util_bx">
                                          ...
                                          <span style="display: none" class="disp_cart_data"
                                             ...
                                             type="hidden" name="attnDivDtlCd" value="10"> <input
                                             type="hidden" name="siteNo" value="6004"> <input
                                             type="hidden" name="attnTgtIdnfNo${list4[loop.index].id}" value="${list4[loop.index].id}">
                                             <input type="hidden" name="attnTgtIdnfNo2" value="6005">
                                             <input type="hidden" name="uitemId" value="00000">
                                             <input type="hidden" name="notiTitle" value="상품이름">
                                             <input type="hidden" name="notiImgPath"
                                    ...
                                    <div class="exp_area notranslate">
                                       <div class="util_bx">
                                          ...
                                          <span style="display: none" class="disp_cart_data"
                                             ...
                                             type="hidden" name="attnDivDtlCd" value="10"> <input
                                             type="hidden" name="siteNo" value="6004"> <input
                                             type="hidden" name="attnTgtIdnfNo${list5[loop.index].id}" value="${list5[loop.index].id}">
                                             <input type="hidden" name="attnTgtIdnfNo2" value="6005">
                                             <input type="hidden" name="uitemId" value="00000">
                                             <input type="hidden" name="notiTitle" value="상품이름">
                                             <input type="hidden" name="notiImgPath"
                                    ...
                                    <div class="exp_area notranslate">
                                       <div class="util_bx">
                                          ...
                                          <span style="display: none" class="disp_cart_data"
                                             ...
                                             type="hidden" name="attnDivDtlCd" value="10"> <input
                                             type="hidden" name="siteNo" value="6004"> <input
                                             type="hidden" name="attnTgtIdnfNo${list6[loop.index].id}" value="${list6[loop.index].id}">
                                             <input type="hidden" name="attnTgtIdnfNo2" value="6005">
                                             <input type="hidden" name="uitemId" value="00000">
                                             <input type="hidden" name="notiTitle" value="상품이름">
                                             <input type="hidden" name="notiImgPath"
                                    ...
                                    <div class="exp_area notranslate">
                                       <div class="util_bx">
                                          ...
                                          <span style="display: none" class="disp_cart_data"
                                             ...
                                             type="hidden" name="attnDivDtlCd" value="10"> <input
                                             type="hidden" name="siteNo" value="6004"> <input
                                             type="hidden" name="attnTgtIdnfNo${list7[loop.index].id}" value="${list7[loop.index].id}">
                                             <input type="hidden" name="attnTgtIdnfNo2" value="6005">
                                             <input type="hidden" name="uitemId" value="00000">
                                             <input type="hidden" name="notiTitle" value="상품이름">
                                             <input type="hidden" name="notiImgPath"
