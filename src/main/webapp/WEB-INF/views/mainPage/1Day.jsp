...
<div class="cmmain_sec_oneday" data-react-tarea-cd="00052_000000748">
        <div class="cmmain_heading">
            <h2 class="cmmain_heading_tit">SSGSSAK 가전</h2>
            </div>
        <div class="cmmain_banner" data-react-unit-type="banr" data-react-unit-id="2003434953" data-react-unit-text='[{"type":"text","value":"배너명"}]'>
                <a href="https://www.ssg.com/service/oneday/dvstore.ssg" class="clickable" data-react-tarea-dtl-cd="t00001">
                    <img src="//sui.ssgcdn.com/cmpt/banner/202308/2023080814274447440133713113_329.jpg" alt="쓱1DAY배송" loading="lazy">
                </a>
            </div>
                        ...
                        <c:if test="${loop.index < onelist.size()}">
                           ...
                           <li class="cunit_t290">
                              <div class="cunit_prod ">
                                 ...
                                 <div class="thmb">
                                    <a
                                       href="/SSGSSAK/product/product.do?productcode=${onelist[loop.index].id}"
                                       ...
                                       srcset="${onelist[loop.index].imgurl}"
                                       src="${onelist[loop.index].imgurl}"
                                       ...
                                       <c:if test="${onelist[loop.index].discount != 0}">
                                          <span class="di_coupon"><span class="blind">쿠폰포함</span>${onelist[loop.index].discount}<em
                                             class="per">%</em></span>
                                       </c:if>
                                    ...
                                    <div class="exp_area notranslate">
                                       <div class="util_bx">
                                          <a href="/SSGSSAK/product/product.do?productcode=${onelist[loop.index].id}" class="blank clickable" target="_blank"
                                          ...
                                          <span style="display: none" class="disp_cart_data"
                                             ...
                                             type="hidden" name="attnTgtIdnfNo${onelist[loop.index].id}" value="${onelist[loop.index].id}">
...
<input type="hidden" id="csrfToken" name="_csrf" value="${_csrf.token}">
                                             <button class="cmlike_btn _js_cmlike_btn clickable"
                                                onclick="addLike(${onelist[loop.index].id})">
                              ...
                              <div class="cunit_info">
                                 ...
                                 <div class="cunit_md notranslate">
                                    <div class="title">
                                       <strong class="brd"> <em class="tx_ko">${onelist[loop.index].brandName}</em>
                                       </strong> <a
                                          href="/SSGSSAK/product/product.do?productcode=${onelist[loop.index].id}"
                                          target="_self" class="clickable" data-info="1000337473259"
                                          data-index="1" data-position="view" data-unit="img"> <em
                                          class="tx_ko">${onelist[loop.index].PDname}</em>
                                       </a>
                                    </div>
                                 </div>
                                 <div class="cunit_price">
                                    <div class="opt_price">
                                       <span class="blind">할인적용가</span> <em class="ssg_price">${onelist[loop.index].sprice}</em>
                                    ...
                                    <div class="org_price_wrap">
                                       <div class="org_price">
                                          <span class="blind">판매가</span> <em class="ssg_price">${onelist[loop.index].optionPrice }</em>
                                          <span class="ssg_tx">원</span>
                                       </div>
                                       <div class="dtl_price_wrap price-tooltip-wrap hide_gl">
                                          ...
                                          <div class="ly_dtl_price price-tooltip-layer">
                                             <dl class="org">
                                                <dt>판매가</dt>
                                                <dd>${onelist[loop.index].optionPrice}</dd>
                                             </dl>
                                             <dl class="dis">
                                             </dl>
                                             <dl class="sum">
                                                <dt>최적가</dt>
                                                <dd>${onelist[loop.index].sprice}</dd>
                                             </dl>
                                          </div>
                                       </div>
                                    </div>
                                 ...
                                 <div class="cunit_app">
                                    <div class="rating">
                                       <div class="rate_bg">
                                          <span style="width: ${onelist[loop.index].avgGrade*20}%"><span class="blind">별점
                                                ${onelist[loop.index].avgGrade}점</span></span>
                                       </div>
                                       <span class="rate_tx">(<em>${onelist[loop.index].reviewCount}</em>개)
                                       </span>
                                    </div>
                                 </div>
