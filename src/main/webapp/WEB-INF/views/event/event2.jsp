...
<script type="text/javascript" async=""
	src="https://linkback.contentsfeed.com/src/20240506/lb4ssg.min.js"
...
<title>이벤트/쿠폰 &gt; [보타닉센스]멜라닌 선스크린</title>

<meta name="title" content="이벤트/쿠폰 > [보타닉센스]멜라닌 선스크린">
...
<script type="text/javascript">
        ...
        window.GA4_dataLayer.push({
            event : 'view_event',
            nevntId : '1000000012976',
            ckwhere : 's_ggbr',
            dispCmptId : '',
            domainSiteNo : '6005',
            Page_title : '[보타닉센스]멜라닌 선스크린',
...
<link rel="stylesheet" type="text/css"
	href="//sui.ssgcdn.com/ui/ssg/css/com_event.css?v=20240424">

<!-- mShareClipMeta -->
<meta property="og:url"
	content="https://event.ssg.com/eventDetail.ssg?nevntId=1000000012976&amp;domainSiteNo=6005">
<meta property="og:image"
	content="https://sstatic.ssgcdn.com/promo/event/ssg/202404/44245356790133203.png">
<meta property="og:title" content="[보타닉센스]멜라닌 선스크린">
<meta property="og:description" content="여기를 눌러 링크를 확인하세요.">
<meta property="og:type" content="website">
<meta name="twitter:card" content="summary">
<meta name="twitter:title" content="[보타닉센스]멜라닌 선스크린">
...
<link rel="stylesheet" type="text/css"
	href="//sui.ssgcdn.com/ui/m_ssg/css/ssg_component.css?v=20240424">
<link rel="stylesheet" type="text/css"
...
<%@include file="../Top.jsp" %>
	...
	<div id="wrap">
		<div id="container">
			<link rel="stylesheet" type="text/css"
				href="//sui.ssgcdn.com/ui/promotion/css/template.css?v=20240424">
			<link rel="stylesheet" type="text/css"
				href="//sui.ssgcdn.com/ui/ssg/css/mndmoon.css?v=20240424">
			<div id="content" class="content_primary content_event"
				...
				<div class="cevent_top">
					<div class="cevent_inner cevent_inner_heading v2">
						<div class="cevent_subject">
							<h2 class="cevent_subject_tit">[보타닉센스]멜라닌 선스크린</h2>
						</div>
						<div class="cevent_date">
							<span class="cevent_data_tit">기간</span> <span
								class="cevent_data_term">2024.05.06 ~ 2024.05.12</span> <span
								class="cevent_data_tit">당첨발표</span> <span
								class="cevent_data_term"> 2024-05-14</span>
						</div>
						<div class="alg_right">
							<ul class="cm_sns">
								<li><a href="javascript:void(0)"
									onclick="facebook_share_new('[\uBCF4\uD0C0\uB2C9\uC13C\uC2A4]\uBA5C\uB77C\uB2CC \uC120\uC2A4\uD06C\uB9B0','[SSG.COM]','https://sstatic.ssgcdn.com/promo/event/ssg/202404/44245356790133203.png','','https://event.ssg.com/eventDetail.ssg?nevntId=1000000012976','EVENT')"
									class="facebook" title="페이스북"><span class="blind">페이스북</span></a></li>
								<li><a href="javascript:void(0)"
									onclick="twitter_share_new('[SSG.COM]','[\uBCF4\uD0C0\uB2C9\uC13C\uC2A4]\uBA5C\uB77C\uB2CC \uC120\uC2A4\uD06C\uB9B0','','https://event.ssg.com/eventDetail.ssg?nevntId=1000000012976','EVENT')"
							...
							<div class="cm_clip cm_clip_planshop">
								<span class="cmlike _js_cmlike interestIt"> <input
									...
									type="hidden" name="attnTgtIdnfNo1" value="1000000012976">
									<input type="hidden" name="attnTgtIdnfNo2" value=""> <input
									type="hidden" name="notiTitle" value="[보타닉센스]멜라닌 선스크린">
									<input type="hidden" name="checked" value="N">
									<button class="cmlike_btn _js_cmlike_btn">
										<span class="cmlike_ico"> <i class="cmlike_primary_m"></i>
				...
				<div class="cevent_content">
					<div>
						<img
							src="https://sstatic.ssgcdn.com/promo/event/ssg/202404/44245131910526589.jpg"
							alt="선스크린_1">
					</div>
					<div>
						<img
							src="https://sstatic.ssgcdn.com/promo/event/ssg/202404/44238040669151726.jpg"
							alt="선스크린_2">
					</div>
					<div>
						<img
							src="https://sstatic.ssgcdn.com/promo/event/ssg/202404/44236744449486457.jpg"
							alt="선스크린_3">
					</div>
					<div>
						<img
							src="https://sstatic.ssgcdn.com/promo/event/ssg/202404/44243427552528548.jpg"
							alt="선스크린_4">
					</div>
					<div>
						<img
							src="https://sstatic.ssgcdn.com/promo/event/ssg/202404/44247670456983867.jpg"
							alt="선스크린_5">
					</div>
					<div>
						<img
							src="https://sstatic.ssgcdn.com/promo/event/ssg/202404/44239448307891354.jpg"
							alt="선스크린_6">
					</div>
				</div>
					...
					<dl class="cevent_info" role="presentation">
						...
						<dd class="cevent_info_cont">
							...
							<ul class="cevent_inp_lst ty_block" role="group"
								...
								<li data-nevnt-prvd-id="1000000009177"><span
									class="cevent_rdo"> <input type="radio" id="radioBtn"
										name="tester_bnf" value="1000000009177"> <label
										for="radioBtn">멜라닌 선스크린 50ml</label>
								</span></li>
							</ul>
										...
										<tr>
											<td>
												<p class="cevent_terms_txt">
													[체험단] 이벤트 서비스는 [주식회사 보타닉센스]에서 주관 운영합니다.<br> 본 이벤트에
													응모하시는 경우 ‘회원 아이디, 성함, 이메일 주소, 휴대폰 번호, 기본주소’가 [주식회사 보타닉센스]에
													제공되며,<br> <b>제공된 개인 정보는 경품 제공의 목적 외에 사용되지 않음을 알려
														드립니다.</b><br> <b>제공된 개인 정보의 보유 및 이용기간은 이벤트 종료 후
														3개월입니다.</b><br> <b>사용목적을 다한 개인 정보는 3개월 이내라도 즉시 파기됩니다.</b><br>
													<br> 고객님께서는 개인 정보 제3자 제공동의를 거부할 권리가 있습니다.<br> 단,
													해당 동의 거부 시 이벤트 참여를 하실 수 없습니다.
												</p> <span class="cevent_chk"> <input type="checkbox"
													id="checkboxBtn01" name="privacy_agree"> <label
													for="checkboxBtn01">개인정보 제공에 동의합니다</label>
											</span>
											</td>
											<td>
												<p class="cevent_terms_txt">
													[체험단] 이벤트 서비스는 [주식회사 보타닉센스] 주관으로 운영됩니다.<br> 본 이벤트의 당첨자
													선정 및 경품 발송 등 진행에 관련된 권한과 책임은 [주식회사 보타닉센스]에 있으며, SSG.COM은 진행
													및 당첨자 선정에 관여하지 않습니다.<br> 응모 시 사용한 ID 회원 정보상의 휴대폰 번호와
													주소지 기준으로 연락 또는 발송됩니다.<br> 주소 입력 오류 등의 고객 실수로 오발송 되는
													경품은 재발송이 불가합니다.
												</p> <span class="cevent_chk"> <input type="checkbox"
													id="checkboxBtn02" name="policy_agree"> <label
													for="checkboxBtn02">운영방침에 동의합니다</label>
											</span>
											</td>
										</tr>
									</tbody>
							...
							<div class="cevent_terms_notice">
								안내 및 유의사항<br> &nbsp;* 당첨 시 상품 수령 후 체험단 후기 작성은 필수이며, 후기 미작성
								시 체험단 이벤트 응모 및 당첨이 제한될 수 있습니다.<br> * 체험단 후기는 상품 받으신 후 1달
								이내로 작성 부탁드립니다.<br> * 경품은 체험단 응모 시 사용한 ID 회원 정보 상의 휴대폰 번호와
								기본 배송지 기준으로 발송되오니 개인정보를 꼭 확인부탁드립니다.<br> * 고객실수로 인한 기본 배송지
								오류 또는 연락처 미기재 등으로 인해 오발송 되는 경품은 재발송이 불가합니다.<br> * 제공받은 제품으로
								리뷰 용도 외 재판매는 절대 불가합니다. 재판매건 적발 시 이후 이벤트 및 응모 당첨이 제한될 수 있습니다.<br>
								* 이벤트에 응모하실 경우 개인정보 제공에 동의하신 것으로 간주되며, 제공된 정보는 당첨 발표 후 즉시 파기합니다.
							</div>
						</dd>
					</dl>
				</div>
				...
				<div class="cevent_sec">
					<fieldset class="fieldset">
						...
						<div class="cevent_comment">
							<span class="cevent_inpbx"> <input type="hidden" value="1"
								id="hiddenEventId" /> <input type="text" name="entryRsnCntt"
								id="entrycomment" class="input_text translated"
								title="댓글을 입력해주세요." placeholder="댓글을 입력해주세요."><span
								class="trans_placeholder blind">댓글을 입력해주세요.</span>
							</span> <span class="cevent_bytechk">0/200자</span> <span class="bnbox"><button
									type="button" onclick="submitEventBtn10()"
									id="submitEventBtn10" class="cevent_btn btn_submit">
					...
					<div id="reply_list_container">
						<table class="cevent_data_tbl">
							<caption>댓글 번호, 댓글 내용, 작성자 아이디, 작성일 순으로 정보를 제공하는 댓글 리스트
								테이블입니다.</caption>
							<colgroup>
							...
							<c:if test="${ not empty event2 }">
								<c:forEach items="${ event2 }" var="adto">
								<tr>
									<td>${ event2.id }</td>
									<td><span class="cevent_comment_txt">
											${ event2.cmmn }</span></td>
									<td class="cevent_writter">${ event2.name }</td>
									<td class="date">${ event2.writingDate }</td>
								</tr>
								</c:forEach>
							</c:if>
							</tbody>
						...
						<div class="cevent_paginate">
							...
							<div class="paging notranslate" id="pagination_id"
								style="width: 100%">
								...
								<c:forEach var="pageNum" begin="1"	end="${ pdto.totalPages }">
					            	...
					            	<c:if test="${not (pageNum eq pdto.currentPage) }">
					            		<a href="<%= request.getContextPath() %>/eventList.do?currentPage=${ pageNum }&eid=1">${ pageNum }</a>
					            	</c:if>
					            </c:forEach>
							</div>
						</div>
    		        	...
    		        	$.ajax({
    		        		...
    		        		success: function(response){
    		        			 var jsonArray = response; // 이 부분에서 실제 응답 데이터 구조에 맞게 조정 필요
    		        		        ...
    		        		        jsonArray.forEach(function(event2, index) {
    		        		            if (event2.comment && event2.WritingDate && event2.name) {
    		        		                var updateQuery = '<tr>';
    		        		                updateQuery += `<td>\${event2.id}</td>`;  
    		        		                updateQuery += `<td><span class="cevent_comment_txt">\${item.comment}</span></td>`;
    		        		                updateQuery += `<td class="cevent_writter">\${event2.name}</td>`; 
    		        		                updateQuery += `<td class="date">\${event2.WritingDate}</td></tr>`;
    		        		        ...
    		        		        var inner = '';
    		        		        jsonArray.forEach(function(event2, index) {
    		        		            if (event2.currentPage && event2.numberPerPage && event2.totalPages) {
    		        		                for (var i = 0; i < event2.totalPages; i++) {  // totalPages에 대한 반복을 수행해야 함
    		        		                    if (event2.currentPage === (i + 1)) {
    		        		                        inner += `<strong title="현재위치">\${event2.currentPage}</strong>`;  // 템플릿 리터럴 수정
    		        		                    } else {
...
/*     
    ...
    $(function () {
        if (UserInfo.isLoginYn !== 'N') {
            var myEntryList = eventCommons.getMyEntryList('1000000012976');
				...
				<div class="ly_chg_cont">
					<div class="ly_chg_tit notranslate">
						<em class="tx_ko">품절일 때 대신 구매하면 좋은 상품을 모았어요!</em> <em
							class="tx_en">The product is currently sold out! You might
							also like</em> <em class="tx_zh">收集了断货时购买的话很好的商品!</em>
					</div>
...
$(function(){
    ...
    function initLayerPopup() {
        ...
        var eventTempDisplayButton = new evtTemp.view.displayButton();
			...
			<script
				src="//sui.ssgcdn.com/ui/ssg/js/lib/infinitegrid.pkgd.min.js?v=20240424"></script>
			<script
				src="//sui.ssgcdn.com/ui/ssg/js/ui/ssg.view.planshopitem.js?v=20240424"></script>
			<script>
    ...
    $(function () {
        try {
            braze.logCustomEvent('이벤트페이지진입', {
                'nevnt_id': '1000000012976',
                'evnt_nm': '[보타닉센스]멜라닌 선스크린',
                'evnt_strt_dts': '2024-05-06T00:00:00KST',
                'evnt_end_dts': '2024-05-12T23:59:59KST',
		...
		<script type="text/javascript"
			src="//sui.ssgcdn.com/ui/ssg/js/jquery.form.js?v=20240424"></script>
		<script type="text/javascript"
		...
		<script type="text/javascript"
			src="//sui.ssgcdn.com/ui/ssg/js/ui/ssg.view.translate.js?v=20240424"></script>
		<script>
$(function(){
...
//르노삼성 고객센터 전화번호 변경
	...
	<script type="text/javascript" id="ga4_jshandler" charset="">function logEvent(a,b){a&&(window.AnalyticsWebInterface?window.AnalyticsWebInterface.logEvent(a,JSON.stringify(b)):window.webkit&&window.webkit.messageHandlers&&window.webkit.messageHandlers.firebase&&(a={command:"logEvent",name:a,parameters:b},window.webkit.messageHandlers.firebase.postMessage(a)))}
...
function ecommerceLogEvent(a,b){a&&b&&(window.AnalyticsWebInterface?window.AnalyticsWebInterface.ecommerceLogEvent(a,JSON.stringify(b)):window.webkit&&window.webkit.messageHandlers&&window.webkit.messageHandlers.firebase&&(a={command:"ecommerceLogEvent",name:a,parameters:b},window.webkit.messageHandlers.firebase.postMessage(a)))};</script>
	<script type="text/javascript" id="" charset="">var linkback=linkback||{};(function(){var a=document,b=a.createElement("script");a=a.getElementsByTagName("head")[0];b.type="text/javascript";b.async=!0;var c=new Date;c=c.getFullYear().toString()+("0"+(c.getMonth()+1)).slice(-2)+("0"+c.getDate()).slice(-2);b.src="https://linkback.contentsfeed.com/src/"+c+"/lb4ssg.min.js";b.charset="utf-8";linkback.l||(linkback.l=!0,a.insertBefore(b,a.firstChild))})();</script>
	<script id="" text="" charset="" type="text/javascript"
		src="https://cdn.onetag.co.kr/0/tcs.js?eid=ubon3jnb3o11ubon3jnb3o"></script>
	<script type="text/javascript"
		src="//sui.ssgcdn.com/ui/promotion/js/template.js?v=20240424"></script>
	<script type="text/javascript"
		src="//sui.ssgcdn.com/ui/promotion/js/hooks.js?v=20240424"></script>
	<script type="text/javascript"
		src="/resources/js/event-commons.js?v=20240424"></script>
	<script type="text/javascript"
		src="//sui.ssgcdn.com/ui/ssg/js/lib/swiper-bundle.min.js?v=20240424"></script>

	<script type="text/javascript" id="" charset="">var checkLbLoaded=function(){linkback.send&&callLbInf()},lbItvFn=setInterval(checkLbLoaded,500),callLbInf=function(){linkback.send("inflow");linkback.track("inflow");clearInterval(lbItvFn)};</script>
