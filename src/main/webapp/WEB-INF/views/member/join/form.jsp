...
//<![CDATA[
    ...
    var ssg = $.extend(ssg || {}, {
        ...
        title : '회원가입 &gt; 정보입력, 믿고 사는 즐거움 SSG.COM'
    });
...
<div id="content" class="cmem_ct_join">
                        ...
                        <dd class="cmem_dd">
                            <div class="cmem_inpgrp ty_pw">
                                <div class="cmem_txt">
                                    ...
                                    <input type="password" placeholder="영문, 숫자 조합 8~20자리로 입력해주세요." id="pwd" name="mbr.pwd" class="translated" maxlength="20"/><span class="trans_placeholder blind" data-default-txt="영문, 숫자 조합 8~20자리로 입력해주세요.">영문, 숫자 조합 8~20자리로 입력해주세요.</span>
  ...
  <!--                   
                    ...
                    <p class="cmem_row" data-reactingv2-key="00198_000000750|t00000|1" style="display: none"></p>
...
/* 
        $("#checkDuplicateLoginIdBtn").click(function (e) {
            ...
            $("#checkDuplicateLoginIdBtn").addClass("working");
            loadingIndicator.show();

            let isDuplicated = ajaxCheckDuplicateMbrLoginId(10);
