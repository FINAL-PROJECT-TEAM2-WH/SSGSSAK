...
<title class="notranslate">검색결과 >노트북, 믿고 사는 즐거움 SSG.COM</title>
<meta name="title" content="노트북-믿고 사는 즐거움 SSG.COM" />
<meta name="description"
	content="노트북도 한번에 쓱~ SSG.COM 검색결과 입니다.삼성노트북,lg노트북,asus노트북,hp노트북,레노버노트북,게이밍노트북,맥북" />
<meta name="google-site-verification"
	content="riDJ-IX46HanskLx25pj6-y8ANf2qTgZNfv_UJvkHq8" />
<meta name="facebook-domain-verification"
	content="ctgl43lmqq8gm4thxgg7j3b38sfqau" />
<link rel="canonical"
	href="https://www.ssg.com/search.ssg?query=%EB%85%B8%ED%8A%B8%EB%B6%81">
<link rel="alternate" media="only screen and (max-width: 640px)"
	href="https://m.ssg.com/search.ssg?query=%EB%85%B8%ED%8A%B8%EB%B6%81">
<link rel="preload"
...
<script type="text/javascript"
	src="//sui.ssgcdn.com/ui/ssg/js/ssg.ad.js?v=20240508"></script>
<script type="text/javascript"
	src="//sui.ssgcdn.com/ui/ssg/js/common/ssg.react.js?v=20240508"></script>
<script type="text/javascript"
	src="//sui.ssgcdn.com/ui/ssg/js/ui/ssg.view.layerpopup.js?v=20240508"></script>
<script type="text/javascript"
	src="//sui.ssgcdn.com/ui/ssg/js/netfunnel.js?v=20240508"
...
<meta property="og:url"
	content="https://www.ssg.com/search.ssg?target=all&query=%EB%85%B8%ED%8A%B8%EB%B6%81" />
<meta property="og:image"
	content="https://sui.ssgcdn.com/ui/common/img/sns/ssg.png" />
<meta property="og:title" content="‘노트북’ 검색을 쓱-" />
<meta property="og:description" content="‘노트북’ 검색결과입니다." />
<meta property="og:type" content="website">
<meta name="twitter:card" content="summary" />
<meta name="twitter:title" content="‘노트북’ 검색을 쓱-" />
<meta name="twitter:description" content="‘노트북’ 검색결과입니다." />
...
<div class="cmctg_kilr{{if C === "5410000002"}} ty_mndmoon{{/if}}{{if C === "5410000004"}} ty_baby{{/if}}{{if C === "1000015889"}} ty_trip{{/if}}{{if C === "1000015890"}} ty_trip{{/if}}">
	...
	<div id="container">
		<link rel="stylesheet" type="text/css"
			href="//sui.ssgcdn.com/ui/ssg/css/common_filter.css?v=20240508" />
		<link rel="stylesheet" type="text/css"
			href="//sui.ssgcdn.com/ui/ssg/css/com_search_v3.css?v=20240508" />
		<link rel="stylesheet" type="text/css"
			href="//sui.ssgcdn.com/ui/ssg/css/mntrip_search.css?v=20240508" />
		<!--
isMsa=Y
-->

		<div id="content" class="react-area content_csrch com_tmpl"
			data-globalid="search" data-typoredirectyn="N" data-typoquery="노트북"
			data-realquery="노트북" data-qrquery="" data-includequery=""
			data-excludequery="" data-itemcount="571710"
			data-react-comm-type="srchwd" data-react-comm-id="노트북"
			data-react-srch-rsv-div-cd="10">
			...
			<div class="csrch_top v2" data-areaid="description">
				<h2 class="notranslate">
					<c:if test="${ not empty searchWord }">
						<span class="tx_ko"><span>‘${ searchWord }</span>’ 에 대한
							검색결과입니다.</span>
					</c:if>
				</h2>
				...
				<input type="hidden" name="parmInclude" id="parmInclude" value="">
				<input type="hidden" name="parmExclude" id="parmExclude" value="">
				<input type="hidden" name="parmTarget" id="parmTarget" value="all">
				<input type="hidden" name="itemCount" id="itemCount" value="571710">
				<input type="hidden" name="parmResultYn" id="parmResultYn" value="">
				<input type="hidden" name="parmPage" id="parmPage" value="">
				<input type="hidden" name="ssgItemCount" id="ssgItemCount"
					value="571517"> <input type="hidden" name="parmCount"
					id="parmCount" value=""> <input type="hidden"
					name="parmSiteNo" id="parmSiteNo" value="6005"> <input
					type="hidden" name="parmFilterSiteNo" id="parmFilterSiteNo"
					value=""> <input type="hidden" name="skipResult"
					id="skipResult" value=""> <input type="hidden"
					name="ajaxTarget" id="ajaxTarget" value="item"> <input
					type="hidden" name="virtualCtgGrpId" id="virtualCtgGrpId" value="">
			</div>
			<!-- //검색 기술문 -->

			<!-- 연관검색어/결과내재검색 -->
			<div class="csrch_help">
				<!-- 연관검색어 -->
				<div class="csrch_relate" data-areaid="srchwdrl">
					<h3>연관검색어</h3>
					<ul>
						<c:choose>
							<c:when test="${ empty srArr }">
								<a href=""><span>연관검색어가 없습니다.</span></a>
							</c:when>
							<c:otherwise>
								<c:forEach items="${ srArr }" var="sr">
									<li><a
										href="<%= contextPath %>/searchQuery.do?searchWord=${ sr }"
										class="clickable">${ sr }</a></li>
								</c:forEach>
							</c:otherwise>
						</c:choose>
				...
				<!-- //연관검색어 -->
				<!-- 결과내재검색 -->
				<div class="csrch_rescan">
					<form onsubmit="return false;">
						<div class="tmpl_drop_wrap">
							<select data-template="#_dropdown" class="_dropdown"
								title="검색항목 선택" style="display: none" id="rescanType">
								<option value="include">결과내재검색</option>
								<option value="exclude">검색어 제외</option>
							</select>
						</div>
						<div class="csrch_rescan_form">
							<input type="text" title="검색어 입력" class="ip" id="rescanText">
			...
			<div class="com_tmpl_lnb">
				<div id="cmflt_lnb" class="cmflt_lnb">
					...
					<div class="cmflt_filbox cmflt_filbox_v2 notranslate"
						id="area_categoryList">
						<!-- 검색LNB -->
						<div class="cmflt_filbox_title">
							<h4 class="notranslate">
								<span class="tx_ko">카테고리</span> <span class="tx_en">Category</span>
								<span class="tx_zh">商品分类</span>
							</h4>
							<button type="button" class="cmflt_toggle on"
								aria-expanded="true">
								<span class="blind">열고닫기토글</span>
							</button>
						</div>
						<div class="cmflt_filbox_cts">
							<div
								class="cmflt_ctlist_search cmflt_ctlist_search_v2 cmflt_scroll"
								id="search_category_list">

								<!--  식품, 침구, 인테리어, 가구, 리빙, 취미, 디지털, 유아동 -->

								<ul class="cmflt_ctlist">
									<c:choose>
										<c:when test="${ empty cclist }">
											<span>해당하는 카테고리가 없습니다.</span>
										</c:when>
										<c:otherwise>
    ...
    function categoryDo(button){
    	...
    	location.href = `<%= request.getContextPath() %>/productlist/productList.do?categoryId=\${ cateVar }&currentPage=1`;
					...
					<div class="cmflt_filbox cmflt_filbox_v2 notranslate"
						...
						<div class="cmflt_filbox_title">
							<h4>
								<span class="tx_ko">브랜드</span> <span class="tx_en">Brand</span>
						...
						<div class="cmflt_filbox_cts ">
							<div class="cmflt_search">
								...
								<button type="submit" class="cmflt_btn_search"
									id="btn_brand_search">
									<span class="blind">검색</span>
								</button>
							</div>
                ...
                var searchBrandList = [];
							...
							<a href="#brandMore" class="cmflt_morego" id="pop_brand_layer">브랜드
								더보기</a>
						</div>
					</div>
					<!-- //브랜드 -->
					...
					<div class="cmflt_filbox cmflt_filbox_v2">
						...
						<div class="cmflt_filbox_cts">
							<div class="cmflt_filbox_price">
								<ul class="cmflt_list_round">
									<li><span class="round_cell"> <input type="radio"
											id="tyPrice1" name="tyPrice" data-filter-type="price"
											data-filter-value="minPrc=0&maxPrc=300000"
											data-filter-title="30만원 이하"
											onclick="SearchPriceFilter.searchPriceChange(this);">
											<label for="tyPrice1" class="round_btn round_btn_pr">30만원
												이하</label>
									</span></li>
									<li><span class="round_cell"> <input type="radio"
											id="tyPrice2" name="tyPrice" data-filter-type="price"
											data-filter-value="minPrc=300000&maxPrc=1200000"
											data-filter-title="30만원 ~ 120만원"
											onclick="SearchPriceFilter.searchPriceChange(this);">
											<label for="tyPrice2" class="round_btn round_btn_pr">30만원
												~ 120만원</label>
									</span></li>
									<li><span class="round_cell"> <input type="radio"
											id="tyPrice3" name="tyPrice" data-filter-type="price"
											data-filter-value="minPrc=1200000&maxPrc=1500000"
											data-filter-title="120만원 ~ 150만원"
											onclick="SearchPriceFilter.searchPriceChange(this);">
											<label for="tyPrice3" class="round_btn round_btn_pr">120만원
												~ 150만원</label>
									</span></li>
									<li><span class="round_cell"> <input type="radio"
											id="tyPrice4" name="tyPrice" data-filter-type="price"
											data-filter-value="minPrc=1500000&maxPrc=99999999"
											data-filter-title="150만원 이상"
											onclick="SearchPriceFilter.searchPriceChange(this);">
											<label for="tyPrice4" class="round_btn round_btn_pr">150만원
												이상</label>
									</span></li>
								</ul>
								<input type="radio" id="tyPrice0" name="tyPrice"
									data-filter-type="price" title="수동입력">
								<div class="cmflt_price_search">
									<input type="text" name="sh_price" title="시작가격"
										id="searchMinPrc"> <span class="swungdash">~</span> <input
										type="text" name="sh_price" title="끝가격" id="searchMaxPrc">
									<button type="submit" class="cmflt_btn_search"
										onclick="SearchPriceFilter.searchInputPrice();">
										<span class="blind">검색</span>
									</button>
								</div>
								<button type="button" class="cmflt_cancel"
									onclick="SearchPriceFilter.searchCancelPrice();">전체해제</button>
					...
					<div class="cmflt_shortcut" data-areaid="collection">
						<ul class="cmflt_shortcut_list">
							<li><a href="javascript:void(0);"
								onclick="fn_clickCollectionNavi('BMPnshop')" class="clickable"
								data-info="pnshop" data-index="" data-position="">기획전</a></li>
							<li><a href="javascript:void(0);"
								onclick="fn_clickCollectionNavi('BMStore')" class="clickable"
								data-info="store" data-index="" data-position="">스토어</a></li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="com_tmpl_content">
				...
				<div class="toolbar">
					<div class="toolbar_content">
						<div class="toolbar_item_group toolbar_filter_group"
							id="search_top_shpp_list">
							<div class="toolbar_filter_item">
								<label> <input type="radio" id="emart_de"
									name="shppClsSortFilter" class="blind" data-filter-type="ssgem"
									data-filter-value="shpp=ssgem" data-filter-title="쓱배송">
									<div class="toolbar_btn_filter ssg ">
										<span class="toolbar_btn_content"> <img
											src="//sui.ssgcdn.com/ui/ssg/img/common/common_delivery_ssg.png"
											srcset="//sui.ssgcdn.com/ui/ssg/img/common/common_delivery_ssg@2x.png 2x"
											alt="쓱배송">
										</span>
									</div>
								</label>
							...
							<div class="toolbar_filter_item">
								<label> <input type="radio" id="mon_de"
									name="shppClsSortFilter" class="blind" data-filter-type="smon"
									data-filter-value="shpp=smon" data-filter-title="새벽배송">
									<div class="toolbar_btn_filter morning ">
										<span class="toolbar_btn_content"> <img
											src="//sui.ssgcdn.com/ui/ssg/img/common/common_delivery_morning.png"
											srcset="//sui.ssgcdn.com/ui/ssg/img/common/common_delivery_morning@2x.png 2x"
											alt="새벽배송">
										</span>
									</div>
								</label>
				...
				<div class="tmpl_seleted" style="display: none">
					<dl>
						...
						<dd>
							<ul id="area_selectedCategory" class="notranslate">
							</ul>
				...
				<div class="toolbar_sort_group v2">
					<!-- 정확도 필터 -->
					<div class="toolbar_checkbox_delivery" style="display: none;">
						<span class="custom_chk tooltip"> <input type="checkbox"
							id="recomSort_chk" name="recomSortYn" checked
							data-filter-type="recomSortYn"> <label
							for="recomSort_chk" id="recomSort_chk_label"> 추천 상품만 보기</label> <span
							class="ssg-tooltip-wrap"> <a href="#"
								class="cmflt_ico_info ssg-tooltip"> <span class="blind">추천
										상품만 보기 안내</span> <i class="icon ty_xs icon_circle_error_emart"
									aria-hidden="true"></i>
							</a> <span class="ssg-tooltip-layer ssg-tooltip-layer_v2">
									<p id="recomSortYn_toolTip">검색 키워드의 카테고리, 브랜드 기준으로 추천 상품이
										정렬되어 노출됩니다.</p>
							</span>
						</span>
						</span>
					...
					<div class="com_tmpl">
						<ul class="tmpl_viewtype">
							...
							<li>
								<div class="viewtype_list">
									<a href="javascript:void(0)" class="ty_thmb on"
										data-filter-type="display" data-filter-value="display=img"><span
										class="blind">이미지형</span> <i
										class="icon ty_s icon_rectangle_2x2" aria-hidden="true"></i></a> <a
										href="javascript:void(0)" class="ty_list"
										data-filter-type="display" data-filter-value="display=list"><span
										class="blind">리스트형</span> <i
										class="icon ty_s icon_rectangle_1x2_with_list"
	...
	function fn_searchCountChange(selectElement) {
	    ...
	    location.href = `<%=contextPath2%>/searchQuery.do?selVal=\${selectedValue}&searchWord=${searchWord}`;
				...
				<div class="tmpl_itemlist" id="area_searchItemList">
					<input type="hidden" name="viewType" id="viewType" value="T">
					...
					<c:choose>
						...
						<c:otherwise>
							<div class="cunit_lst_v" id="divProductImg"
										...
										<li class="cunit_t232">
											<div class="cunit_prod ">
												...
												<div class="thmb">
													<a
														...
														target="_self" class="clickable"> <img
														srcset="${ svo.imgurl }" src="${ svo.imgurl }" class="i1"
														width="232" height="232" alt="${ svo.pcontent }"
														loading="lazy"> <img srcset="${ svo.imgurl }"
														src="${ svo.imgurl }" class="i2" width="232" height="232"
														alt="${ svo.pcontent }" aria-hidden="true" loading="lazy">
													</a>
											...
											<div class="cunit_info">
												...
												<div class="cunit_md notranslate">
													<div class="title">
														<strong class="brd"> <em class="tx_ko">${ svo.brandname }</em>
														</strong> <a
															href="/SSGSSAK/product/product.do?productcode=${ svo.productid }"
															target="_self" class="clickable"
															data-info="1000587710191" data-index="0"
															data-position="view" data-unit="img"> <em
															class="tx_ko">${ svo.pdname }</em>
														</a>
													</div>
												</div>
												<c:forEach items="${ plist }" var="prdto">
												...
												<div class="cunit_bene">
													<div class="spt_deiv">
														<div class="cunit_tipbox cunit_depart_today">
															<div class="cunit_tipbox_layer ly_tipbox_layer"
																aria-hidden="true">${ svo.shippingoptionexplain }</div>
														</div>
														<div class="tx_deiv">
															<span>${ svo.soptionname }</span><br> <span>배송비
																${ svo.defaultshippingfee }원</span>
														</div>
													</div>
												</div>
											</div>
					...
					<div class="cunit_info">
						<div class="cunit_tp">
							...
							<!-- [D] 검색결과 만족도 만족 선택시 display:block -->
	...
	document.addEventListener('DOMContentLoaded', function() {
	    // 모든 상품 항목을 선택
	    const productItems = document.querySelectorAll('.rating');
	
	    // 각 상품 항목에 대해 별점 설정
	    productItems.forEach(item => {
	        const rating = parseFloat(item.getAttribute('data-rating'));
	        const rateFill = item.querySelector('.rateFill');
	        const ratingPercentage = (rating / 5) * 100;
	
	        rateFill.style.width = ratingPercentage + '%';
	    });
	});
</script>
						<script type="text/javascript">
...
$(document).ready(function() {
    /* 검색 버튼 */
    $('#bottomSearchBtn').bind('click', function(e) {
        if($('#bottomSearchQuery').val()==''){
            alert($.i18n.prop('i18n.front.search.keyword.검색어를입력하세요'));
            return false;
        }
    });
    /* 검색창 엔터 */
    $("#bottomSearchQuery").keypress(function(e){
        if (e.which == 13) {
            if($('#bottomSearchQuery').val()==''){
                alert($.i18n.prop('i18n.front.search.keyword.검색어를입력하세요'));
                return false;
			...
			<div id="target_div" style="width: 0; height: 0; display: none">
			</div>
			...
			<script type="text/javascript"
				src="//sui.ssgcdn.com/ui/ssg/js/nevnt.js?v=20240508"></script>
			<script type="text/javascript"
			...
			<script type="text/javascript"
				src="//sui.ssgcdn.com/ui/ssg/js/ui/ui.datepicker.js?v=20240508"></script>
			<script type="text/javascript"
			...
			<script type="text/javascript"
				src="https://sui.ssgcdn.com/ui/ssg/js/ui/ssg.view.translate.js?v=20240508"></script>
			<script>
$(function(){
    var oSsgViewTranslate = new ssg.View.translate({
        i18nConfig: {
			...
			<script type="text/javascript"
				src="//sui.ssgcdn.com/ui/ssg/js/ui/ssg.view.search_v2.js?v=20240508"></script>
			<script type="text/javascript"
				src="//sui.ssgcdn.com/ui/ssg/js/ui/ssg.view.main_v2.js?v=20240508"></script>

			<script type="text/javascript"
				src="//sui.ssgcdn.com/ui/ssg/js/ui/ui.timerManager.js"></script>
			<script type="text/javascript"
				src="//sui.ssgcdn.com/ui/ssg/js/lib/masonry.pkgd.min.js"></script>
			<script type="text/javascript"
				src="//sui.ssgcdn.com/ui/ssg/js/category/otherItemMore.js"></script>

			<script type="text/javascript"
				src="//sui.ssgcdn.com/ui/ssg/js/jquery.history.js"></script>
			<script type="text/javascript"
				src="//sui.ssgcdn.com/ui/ssg/js/srch/comm/srch.unity.at.js?v=20240508"></script>
			<script type="text/javascript"
				src="//sui.ssgcdn.com/ui/ssg/js/srch/comm/srch.unity.ui.js?v=20240508"></script>
			<script type="text/javascript"
				src="//sui.ssgcdn.com/ui/ssg/js/ui/ssg.view.cmfilter.js?v=20240508"></script>
			<script type="text/javascript"
				src="//sui.ssgcdn.com/ui/ssg/js/ssg.sa.js?v=20240508"></script>

			<script type="text/javascript" defer="defer">
    var parentBrandIds = null;
    $(document).ready(function() {
        // 검색 가이드 (masonry 플러그인 사용)
        $('body').on("click","#relation_exhibition", function(){
            $('#masonry').masonry({
        ...
        // 연관검색어 더보기
        var welRelateSearch = $('#relateSearch'),
            welBtnViewMore  = welRelateSearch.find('.relate_more'),
            nWrapWidth      = welRelateSearch.find('.relate_content').width(),
            nInnerWidth     = welRelateSearch.find('.relate_link').width();

        if( welRelateSearch.length && nInnerWidth > nWrapWidth ){
            welBtnViewMore.show().on('mouseenter focusin', function() {
                $(this).addClass('on');
        ...
        /* 더보기 버튼 */
        $('.csrch_btnarea a').bind('click', function(e) {
            $.ajax({url: "/comm/ajaxDummyTrackingUrl.ssg?Egnb=cate_more"});
        });
    });
</script>
    ...
    {{if label == "추천순" || label == '推荐顺序' || label == 'Recommended'}}
    ...
    {{each(index, row) items}}
        {{if value !== "0"}}
            {{if selected}}
                ...
                {{/if}}
            {{else label == "추천순" || label == '推荐顺序' || label == 'Recommended'}}
                <li data-index="{{= index}}">
                    <a href="#"><span class="txt">{{= label}}</span></a>
                    <button type="button" class="ssg-tooltip"><span class="blind">추천순 설명 보기</span></button>
                </li>
    ...
    $(function() {
        ...
        if( $('#cmflt_lnb').length ){
			...
			<!-- 리타겟팅 광고 스크립트 추가 -->
			<iframe
				src="https://asia.creativecdn.com/tags?id=pr_0eprxmL3KSJIVYpHgQkK_listing_1000587710191,1000528222225,1000526967106,1000587866133,1000576468800&amp;id=pr_0eprxmL3KSJIVYpHgQkK_custom_site_ssg"
...
deferredObj.done(function() {
    ...
    window.criteo_q.push(
            ...
            { event: "viewList", item: ["1000587710191","1000528222225","1000526967106"], mall_type: "ssg", keywords: "노트북"}
    );
});
</script>
...
//르노삼성 고객센터 전화번호 변경
    ...
    Nethru_makePersistentCookie1("RC",10,"/",Nethru_domain);
		...
		<div class="ssg-layer-popup store_lypop v2" id="like_coupon"
			...
			<button type="button"
				class="store_couponpop_btn store_layer_btn_close">
			...
			<div class="ly_chg_cont">
				<div class="ly_chg_tit notranslate">
					<em class="tx_ko">품절일 때 대신 구매하면 좋은 상품을 모았어요!</em> <em class="tx_en">The
						product is currently sold out! You might also like</em> <em
						class="tx_zh">收集了断货时购买的话很好的商品!</em>
				</div>
...
$(function(){
	...
	<script type="text/javascript"
		src="//sui.ssgcdn.com/ui/ssg/js/history.js?v=20240508"></script>
	<script type="text/javascript"
...
(function() {
	...
	<!-- 검색결과만족도 -->
	<div class="csrch_survey v2">
		<h3>검색결과에 만족하십니까?</h3>
		<ul class="survey_list" id="survey_list">
			<li><span class="survey_rdo"> <input type="radio"
					id="tySurvey01" name="tySurvey" value="1"> <label
					for="tySurvey01"><span class="ico_survey1"></span>네, 만족해요!</label>
			</span></li>
			<li><span class="survey_rdo"> <input type="radio"
					id="tySurvey02" name="tySurvey" value="2"> <label
					for="tySurvey02"><span class="ico_survey2"></span>아니요, 만족하지
						않아요.</label>
			</span></li>
		</ul>

		<!-- [D] 검색결과 만족도 만족 선택시 display:block -->
		<div class="survey_type1" id="survey_type1">
			<p>
				<span class="ico_survey1"></span>설문에 참여해 주셔서 감사합니다. 검색결과 개선에
				노력하겠습니다.
			</p>
		</div>

		<!-- [D] 검색결과 만족도 만족하지 않음 선택시 display:block -->


		<!-- 레이어팝업 : 사진첨부 -->
		<div class="ssg-layer-popup ly_file_upload" id="layerFileUpload">
			<div class="ly_cont">
				<h3>사진파일 첨부</h3>
				<form name="fileUploadFrm" method="post">
					<div class="fileupload_wrap">
						<label class="blind" for="fileName">파일명</label> <input type="text"
							id="fileName" class="ip" readonly="readonly" />
						<div class="upload_area">
							<input type="file" class="btn_upload_file" id="upload"
								name="atchFile"
								onchange="javascript:document.getElementById('fileName').value = this.value" />
							<label for="upload" class="btn_upload"><span
								class="blind">파일첨부</span></label>
						</div>
					</div>
				</form>
				<p class="desc">2mb미만의 jpg,gif,png 파일만 첨부하실 수 있습니다.</p>
				<div class="ly_btn_area">
					<a href="#" class="color1 ssg-layer-close" id="imgSaveBtn"
						onclick="fn_searchFileAdd(this)">확인</a> <a href="#"
						class="color2 ssg-layer-close">취소</a>
				</div>
				<button type="button" class="ssg-layer-close ly_close_btn">
	...
	<!-- 하단 검색창  -->
	<div class="csrch_btmbox">
		<div class="searching_box">
			<form action="/search.ssg" method="get" name="topsearch">
				<input type="hidden" id="bottomSearchTarget" name="target"
					value="all"> <input type="hidden" id="bottomFilterSiteNo"
					name="filterSiteNo" value=""> <input type="text"
					id="bottomSearchQuery" name="query" title="검색어 입력" maxlength="60"
					class="ipt_txt txt">
				<button type="submit" title="검색" class="btn_search"
					id="bottomSearchBtn">
					<span class="blind">검색</span>
...
$(function(){
	...
	<!-- 리타겟팅 광고 스크립트 추가 -->
	<iframe
		src="https://asia.creativecdn.com/tags?id=pr_0eprxmL3KSJIVYpHgQkK_listing_1000560833167,1000296377985,1000574193927,1000439448607,1000543767213&amp;id=pr_0eprxmL3KSJIVYpHgQkK_custom_site_ssg"
		width="1" height="1" scrolling="no" frameBorder="0"
		style="display: none;"></iframe>
...
deferredObj.done(function() {
    ...
    window.criteo_q.push(
            ...
            { event: "setCustomerId", id: settings.UserInfo.mbrLoginId2 },
            { event: "setSiteType", type: "d" },
            { event: "viewList", item: ["1000560833167","1000296377985","1000574193927"], mall_type: "ssg", keywords: "나이키 신발"}
    );
});
</script>
	<!-- END Criteo 카테고리/검색/리스팅 태그 -->
